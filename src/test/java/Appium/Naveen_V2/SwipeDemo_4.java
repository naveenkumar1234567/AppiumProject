...
public class SwipeDemo_4 extends BasicTest{
@Test
	public void swipe()
	{
...
String focus=	firstImg.getAttribute("focusable");
		...
		swipeLeft(firstImg,"right");
		
		
		String focusRecheck =	firstImg.getAttribute("focusable");
		Assert.assertEquals(focusRecheck, "false");
	}
